    ...
    <main>
        <div class="section_1">
            <div class="section_1_container" id="slider_1">
                <div class="section_1_slider"> 대표 사진1</div>
                <div class="section_1_slider"> 대표 사진2</div>
                <div class="section_1_slider"> 대표 사진3</div>
            </div>
            <div class="section_1_controls">
                <button class="section_1_button" id="prev">이전</button>
                <button class="section_1_button" id="next">다음</button>
            </div>
            <div class="dots" id="dots"></div>
        </div>
        <div class="section_2">
            <div class="section_2_box">
                <div class="section_2_title"><h2>제목</h2></div>
                <div class="section_2_subtitle"><h3>세부 내용</h3></div>
                <div class="Car_color">
                ...
                <div class="Car_type" >
                    <div class="Car_type_box Car_type_box_scroll Car_type_js_1" id="Car_type_div">
                        <div  class="Car_conten">
                            <div  class="car_box">
                                <div class="car_photos">사진 넣는곳</div>
                                <div class="car_list">
                                    <div>자동차 이름</div>
                                    <div>가격</div>
                                </div>
